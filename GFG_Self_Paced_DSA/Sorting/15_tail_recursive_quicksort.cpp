...
void quicksort ( int arr[] , int l , int h )
{
    ...
    if ( l < h )    // if l==h, array is already sorted
    {
        ...
        l = p+1 ;   //? Now, the control goes back to the top of the function.
        //? We've already called recursion for the left partition, and instead of calling 
        //? another recursive function, for the right parition, we just update the value of l
        //? and continue from this function only
        goto Begin ;
    }
}
